...
int main() {
    ...
    const long BUFFER_SIZE = 1 * 1024;  // Buffer size set to 512 KB
    ...
    std::ofstream outFile("C:/Users/cmirand4/Documents/MATLAB/VI_Data/streamTest/stream0.bin", std::ios::binary); // Laptop
    if (!outFile.is_open()) {
    ...
    const long BUFFER_THRESHOLD = 10 * 1024 * 1024;  // 10 MB threshold
